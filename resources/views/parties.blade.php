                    ...
                    <tbody>
                        @foreach ($accountremainingbalances as $accountremainingbalance)
                            <tr>
                                ...
                                <td>{{ $accountremainingbalance->amount }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-content">
            ...
            <form method="get" action="{{ route('addnewparty') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput"
                            placeholder="name@example.com" name="companyname" value="{{ $companyDetail->company_name}}">
                        <label for="floatingInput">Company Name</label>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingInput"
                                    placeholder="Vat Number" name="vatnumber" value="{{ $companyDetail->vat_number }}">
                                <label for="floatingInput">Vat Number</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingInput"
                                    placeholder="Phone Number" name="phonenumber" value="{{ $companyDetail->phone_number }}">
                                <label for="floatingInput">Phone Number</label>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-around m-3">
                        <h6 id="additionalinfo" class="under-border editadditionalinfo">Additional Information</h6>
                        <h6 id="otherinfo" class="editotherinfo">Other Information</h6>
                    </div>
                    <div class="additionalinfo">
                        <div class="row">
                            <div class="col">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        placeholder="Address" name="address" value="{{ $companyDetail->address }}">
                                    <label for="floatingInput">Address</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                        placeholder="Email" name="emailaddress" value="{{ $companyDetail->email_address }}">
                                    <label for="floatingInput">Email Address</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="otherinfo hide">
                        <div class="row">
                            <div class="col">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="floatingInput"
                                        placeholder="Opening Balance" name="openingbalance" value="{{ $companyDetail->opening_balance }}">
                                    <label for="floatingInput">Opening Balance</label>
                                </div>
                            </div>
                            <div class="col">
        ...
        $(document).ready(function() {
            ...
            $("tr").dblclick(function() {
                ...
                if (id) {
                    ...
                    window.location.href = '/parties/' + id + '/' + companyName;
                } else {
