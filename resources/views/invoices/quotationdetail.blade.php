...
@section('content')
    ...
    <div class="c-grid-item ">
        ...
        <div>
            ...
            <form action="{{ route('updatequotation') }}" method="GET">
                <div>
                ...
                <div class="d-flex justify-content-end m-2">
                    ...
                    <input type="number" class="align-input" placeholder="Bill No" name="billno" value={{ "$billno" }}
                        readonly>
                </div>
                <div class="d-flex justify-content-end m-2">
                ...
                <table class="table table-bordered mt-4">
                    ...
                    @foreach ($quotationdetails as $quotationdetail)
                        <tr class="billbody">
                            ...
                            <td><input type="number" placeholder="Quantity" name="quantity[]"
                                    value={{ "$quotationdetail->quantity" }}></td>
                            <td><input type="number" placeholder="Rate" name="rate[]"
                                    value={{ "$quotationdetail->rate" }}></td>
                            <td><input type="number" placeholder="Amount" name="amount" readonly
        ...
        <div class="c-below">
            <div class="d-flex justify-content-end p-1">
                <form method="post" action="">
                    @csrf
                    <button type="submit" class="btn btn-secondary mt-2 me-4">Update</button>
                </form>
